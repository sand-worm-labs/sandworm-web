...
export const getResultStatus = (
  ...
  switchBlockType(block, {
    ...
    onVisualization: () => "idle", // VisualizationBlock type removed
...
export function isInputBlock(block: YBlock): boolean {
  return switchBlockType(block, {
    onPython: () => false,
    onSQL: () => false,
    onVisualization: () => false, // VisualizationBlock type removed
...
export function duplicateBlock(
  ...
  return switchBlockType<YBlock>(block, {
    ...
    onVisualization: block => block, // VisualizationBlock type removed - return as-is
