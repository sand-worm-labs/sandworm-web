...
import { GetFileResult, IJupyterManager } from './_index.js'
import path from 'path'
import { Readable } from 'stream'
import { broadcastEnvironmentStatus } from '../websocket/workspace/environment.js'
import { logger } from '../logger.js'
import { SandwormJupyterExtension } from './_extension.js'
...
export class JupyterManager implements IJupyterManager {
  ...
  public constructor(
    ...
    this.jupyterExtension = new SandwormJupyterExtension(
      protocol,
      host,
      port,
      token
  ...
  public async listFiles(_workspaceId: string): Promise<SandwormFile[]> {
    await this.ensureRunning()
