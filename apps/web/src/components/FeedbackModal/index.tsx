                  ...
                  <div className="overflow-y-auto px-6 pb-6 flex-1 space-y-5">
                              ...
                              {REPORT_TYPES.map(type => (
                                ...
                                >
                                  {({ active, selected }) => (
                                    ...
                                    >
                                      <span
                                        className={`shrink-0 ${selected ? "text-gray-900" : "text-ink-400"}`}
                                      >
                                        {type.icon}
                                      </span>
                                      <div className="min-w-0">
                                        <p
                                          className={`text-[13px] font-medium ${selected ? "text-gray-900" : "text-gray-700"}`}
                                        >
                                          {type.label}
                                        </p>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span
                          className={`text-[11px] tabular-nums ${charsLeft < 100 ? "text-amber-500" : "text-ink-400"}`}
                        >
                          {charsLeft} left
                        </span>
                      </div>
                        ...
                        >
                          <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-ink-400">
                            ...
                            >
                              ...
                              />
                              <path
                                d="M2 11v1a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1v-1"
                                stroke="currentColor"
                                strokeWidth="1.3"
                                strokeLinecap="round"
                              />
                          ...
                          {files.map((file, i) => (
                            ...
                            >
                              <span className="text-ink-400">
                                ...
                                >
                                  <path
                                    d="M2 1.5A.5.5 0 0 1 2.5 1h6l3 3v8a.5.5 0 0 1-.5.5h-9A.5.5 0 0 1 2 12V1.5Z"
                                    stroke="currentColor"
                                    strokeWidth="1.1"
                                    strokeLinejoin="round"
                                  />
