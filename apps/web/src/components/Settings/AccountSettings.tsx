            ...
            <div className="flex items-center justify-between sm:gap-4 sm:py-6">
              <div className="flex flex-col gap-y-2 justify-left">
                <label
                  ...
                  className="block text-md font-medium leading-6 dark:text-white sm:pt-1.5"
                >
                  Workspace name
                </label>
            ...
            <div className="flex items-center justify-between sm:gap-4 sm:py-6">
              <div className="flex flex-col gap-y-2 justify-left">
                <label
                  ...
                  className="block text-md font-medium leading-6 text-gray-900 dark:text-white  sm:pt-1.5"
                >
                  Custom model
                </label>
                <span className="text-xs text-gray-400">
                  Connect your own model using a personal API key.
                </span>
              </div>
            ...
            <div className="space-y-8 border-b border-gray-900/10 pb-0 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 ">
              <div className="flex items-center justify-between sm:gap-4 sm:py-6">
                <div className="flex flex-col gap-y-2 justify-left">
                  ...
                  <span className="text-xs text-gray-400">
                    {`Enter your OpenAI API key to customize the default sandworm agent".`}
                  </span>
                </div>
