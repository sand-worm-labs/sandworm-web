      ...
      <Dialog onClose={props.onHide} className="relative z-[1000]">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto font-body ">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-y-auto rounded-2xl bg-white dark:bg-page-surface  dark:border-border-tertiary dark:border text-left  transition-all sm:my-8 px-8 py-6 w-[600px] max-h-[90vh]">
                <div>
