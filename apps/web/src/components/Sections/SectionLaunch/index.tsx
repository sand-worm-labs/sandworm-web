...
export const FeatureCard = ({ children, className = "" }: FeatureCardProps) => {
  return (
    <div
      className={`rounded-2xl backdrop-blur-sm gradient-border  ${className}`}
    >
  ...
  return (
    <section className="py-32 bg-black text-white">
      <div className="container mx-auto px-5 py-16 ">
        <h3 className="uppercase mb-5 text-sm font-semibold mt-5 text-center">
          ● Built to Last ●
        </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {/* ════════════ Third Card ════════════ */}
          <FeatureCard className="lg:col-span-2 gap-10 w-full">
