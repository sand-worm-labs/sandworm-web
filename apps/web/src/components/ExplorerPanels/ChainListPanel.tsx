    ...
    <div className="flex flex-col  w-full ">
      {chains.map(chain => (
        <button
          type="button"
          key={chain.name}
          className="cursor-pointer py-3 px-3 rounded-none hover:bg-white/15 text-sm text-left flex items-center lowercase  justify-between border-b last:border-b-0 transition-colors border-b-[#E9ECEF] dark:border-[#262A30] "
