...
export const GitFork: React.FC<IconProps> = ({ size, className }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M4 5.5V7C4 7.26522 4.10536 7.51957 4.29289 7.70711C4.48043 7.89464 4.73478 8 5 8H11C11.2652 8 11.5196 7.89464 11.7071 7.70711C11.8946 7.51957 12 7.26522 12 7V5.5"
        stroke="currentColor"
        strokeWidth="0.75"
        strokeLinecap="round"
