          ...
          >
            <div
              className={clsx(
                ...
                !isCodeHidden &&
                  "divide-x divide-gray-200 dark:divide-border-tertiary",
                props.hasMultipleTabs ? "rounded-tl-none" : "",
            ...
            >
              <div className="select-none text-gray-300 text-xs flex items-center w-full h-full gap-x-1.5 px-4">
                ...
                <input
                  type="text"
                  className={clsx(
                    "text-base font-primary font-medium pl-1 ring-gray-200 focus:ring-gray-400 block w-full rounded-2xl border-0 text-ink-100 hover:ring-1 focus:ring-1 ring-inset focus:ring-inset placeholder:text-ink-400 py-0 disabled:ring-0 h-2/3 bg-transparent focus:bg-base-100"
                  )}
                  placeholder={
                        ...
                        headerSelectValue !== "duckdb" && (
                          <button
                            ...
                            className={clsx(
                              ...
                              "flex items-center border rounded-sm border-gray-200 px-2 py-1 gap-x-1 text-ink-400 group relative font-primary"
                            )}
                          >
