  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex items-center justify-end gap-x-4">
        ...
        <button
          type="submit"
          className="flex items-center gap-x-2 rounded-sm shadow-sm bg-[#A308F0] px-6 py-2.5 text-sm font-semibold hover:bg-primary-300 border-stone-950 disabled:bg-gray-300 disabled:cursor-not-allowed"
