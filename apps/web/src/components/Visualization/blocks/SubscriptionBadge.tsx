                    ...
                    <div className="pt-4 pb-2 text-md text-gray-500 flex flex-0 flex-col items-center gap-y-6 px-3">
                      <div className="flex flex-col gap-y-3 text-left">
                        <p>
                          ...
                          number of seats, pages, and schedules, as well as
                          Python, SQL, and Visualizations.
                        </p>
                        <p>
                          If you need SSO, granular permissions, PDF exports, or
                          integrations, please consider upgrading your plan.
                        </p>
                      </div>
                    </div>
                  </div>
