        ...
        <>
          <TutorialStep
            ...
            description={
              <>
                <p>
                  You can connect a database in the 'data sources' page at the
                  bottom left corner.
                </p>
                <p>
                  When adding a data source, pick your database type, and enter
          ...
          <TutorialStep
            ...
            description={
              <>
                <p>
                  Add a query block to a page, select the data source you've
                  just connected, and write your query.
                </p>
          ...
          <TutorialStep
            ...
            description={
              <>
                ...
                Tip: you can manipulate query results with Python. sandworm puts
                every query's result into variable containing a Pandas Data
                Frame.
              </>
            }
          ...
          <TutorialStep
            ...
            description={
              <>
                <p>
                  Switch to the dashboard view using the button at the top right
                  corner.
                </p>
                <p>
                  Then, drag and drop your notebook's blocks to create a
                  dashboard.
                </p>
                <p>
                  When you're done, click the 'save' button to save your
                  dashboard.
                </p>
              </>
            }
          ...
          <TutorialStep
            ...
            description={
              <>
                <p>
                  Add users by accessing the users page and clicking the 'add
                  user' button on the top right corner.
                </p>
                <p>
                  Every time you add a user, we'll generate a random password
                  for them. Once they log in, they can change it.
                </p>
              </>
            }
