    ...
    <Listbox value={value} onChange={onChange} disabled={!isEditable}>
      {({ open }) => (
        <div className="relative dark:bg-base-100">
          ...
          >
            <div className="border border-gray-200 dark:border-border-tertiary rounded-md px-3 flex items-center justify-between gap-x-2 w-full min-h-8">
          ...
          {ReactDOM.createPortal(
            ...
            >
              ...
              >
                <Listbox.Options
                  as="div"
                  className="w-[30rem] z-20 mt-2 divide-y divide-gray-200 overflow-hidden rounded-md bg-white  dark:bg-base-200 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none px-5 py-4 dark:border-border-tertiary dark:border "
                >
                      ...
                      <Listbox.Option
                        ...
                        className={({ active }) =>
                          clsx(
                            active
                              ? " border-primary"
                              : "border-gray-200 dark:border-tertiary",
                            option.comingSoon
                              ? "cursor-not-allowed"
                              : "cursor-pointer",
