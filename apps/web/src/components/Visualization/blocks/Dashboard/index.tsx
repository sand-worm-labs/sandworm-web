        ...
        {props.role !== "viewer" && props.isEditing && (
          ...
          >
            <button
              ...
              className="flex items-center rounded-sm px-3 py-1 text-sm bg-[#C7665C] text-white hover:bg-primary-300 border border-transparent disabled:border-gray-200 disabled:bg-gray-100 disabled:cursor-not-allowed gap-x-1.5 group relative disabled:text-gray-500"
              onClick={onPublish}
