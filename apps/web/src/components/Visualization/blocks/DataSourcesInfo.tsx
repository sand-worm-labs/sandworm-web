                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left flex flex-col gap-y-6">
                    ...
                    <div className="text-sm text-gray-500 flex flex-col gap-y-1">
                      ...
                      <p>
                        ...
                        VPN to allow sandworm to connect to your database.{" "}
                    ...
                    <div className="text-sm text-gray-500 flex flex-col gap-y-1">
                      ...
                      <div className="flex flex-col gap-y-2">
                        <p>
                          sandworm does a lot to protect your data. Besides
                          using industry-standard encryption, we also run
                          penetration tests and audits to ensure our security
                          practices are up to date.
                        </p>
                        <p>
                          If you have any questions about our security
                          practices, please send us an email at
                          contact@sandworm.cloud or{" "}
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-semibold underline hover:text-gray-600"
                            href="https://calendly.com/lucasfcosta/sandworm-intro-call"
                          >
                            book a call here
                          </a>
