...
export default function ShareDropdown(props: Props) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left h-full">
      <Menu.Button className="flex items-center rounded-sm px-3 py-1 text-sm dark:border-border-tertiary border text-gray-500 hover:bg-gray-100  border-gray-200 overflow-hidden group max-w-[42px] xl:max-w-[94px] hover:max-w-[94px] transition-mw duration-500 bg-white dark:bg-base-100 ">
                ...
                <div className="px-4 py-3">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      message="Upgrade to sandworm cloud’s professional tier to use them."
                      className="flex"
