        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled
                className="w-full px-3 py-1  rounded-md dark:bg-[#1A1A1A] border dark:border-[#262A30] border-[#DEE2E6] dark:text-white placeholder:dark:text-ink-300  placeholder-[#455768] focus:outline-none  focus:border-[#A308F0] transition text-xs md:text-sm bg-[#F1F3F4] cursor-not-allowed max-w-[30rem]"
              />
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1  rounded-md dark:bg-[#1A1A1A] border dark:border-[#262A30] border-[#DEE2E6] dark:text-white placeholder:dark:text-ink-300  placeholder-[#455768] focus:outline-none  focus:border-[#A308F0] transition text-xs md:text-sm bg-[#F1F3F4] max-w-[30rem]"
          ...
          <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-1.5  rounded-md dark:bg-[#1A1A1A] border dark:border-[#262A30] border-[#DEE2E6] dark:text-white placeholder:dark:text-ink-300  placeholder-[#455768] focus:outline-none  focus:border-[#A308F0] transition text-xs md:text-sm bg-[#F1F3F4] max-w-[30rem] min-h-[6rem] resize-none"
                value={formData.bio}
                onChange={handleChange}
              />
              <span className="text-xs text-gray-500 dark:text-gray-400 mt-1 block">
          ...
          <div className="flex items-center gap-3 pt-4">
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-[#A308F0] text-white rounded-xl hover:bg-[#B55A50] text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
