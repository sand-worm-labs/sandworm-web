...
import { PivotAiExecutorService } from '../pivot-ai-executor.service';
...
function makeService() {
  ...
  const service = new PivotAiExecutorService(yjsDocumentService, persistorFactory, eventEmitter);
  return { service, yjsDocumentService, persistorFactory, eventEmitter };
}

describe('PivotAiExecutorService', () => {
