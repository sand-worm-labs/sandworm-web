...
export class SandwormJupyterExtension {
  ...
  public async statFile(filePath: string): Promise<StatFileResult> {
    ...
    const res = await axios.get(
      `${this.baseURL}/api/sandworm/files/stat?${params}`,
      {
        headers: {
  ...
  public async listFiles(dirPath: string): Promise<ListFilesResult> {
    ...
    const res = await axios.get(
      `${this.baseURL}/api/sandworm/files/list?${params}`,
      {
        headers: {
          Authorization: `token ${this.token}`,
        },
  ...
  public async readFile(filePath: string): Promise<ReadFileResult> {
    ...
    const res = await axios.get<Readable>(
      `${this.baseURL}/api/sandworm/files/read?${params}`,
      {
        headers: {
          Authorization: `token ${this.token}`,
        },
  ...
  public async writeFile(
    ...
    const res = await axios.post(
      `${this.baseURL}/api/sandworm/files/write?${params}`,
      stream,
      {
        headers: {
          Authorization: `token ${this.token}`,
  ...
  public async deleteFile(filePath: string): Promise<DeleteFileResult> {
    ...
    const res = await axios.delete(
      `${this.baseURL}/api/sandworm/files/remove?${params}`,
      {
        headers: {
          Authorization: `token ${this.token}`,
        },
  ...
  public async getCWD(): Promise<string> {
    const res = await axios.get(`${this.baseURL}/api/sandworm/cwd`, {
      headers: {
        Authorization: `token ${this.token}`,
      },
      responseType: 'json',
