...
pnpm --filter=@sandworm/postgresql-typeorm migration:up

# Revert last migration
pnpm --filter=@sandworm/postgresql-typeorm migration:down

# Generate new migration
pnpm --filter=@sandworm/postgresql-typeorm migration:generate src/migrations/<migration-name>

# Show migration status
pnpm --filter=@sandworm/postgresql-typeorm migration:show
```
